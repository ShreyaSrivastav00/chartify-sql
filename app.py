...
# API key input
api_key = st.text_input("Enter your Google API key here:")

# Database path
database_path = 'data.db'

# Define the prompt for GPT-3.5 API
prompt = """
...
- Example Question 3: "What is the total amount spent by females vis-a-vis Card Type?"
